...
Shortly after I started I realized that I wanted the programs to be able to run with emojis in the text strings so I've taken care to ensure that emojis work as both inputs and outputs. In that way we can also embellish the original programs with emojis which I htink adds a little decorative flair.
